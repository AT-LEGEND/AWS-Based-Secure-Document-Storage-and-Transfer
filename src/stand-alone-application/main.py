...
def main():
	...
	text3.grid(row=5)
	sidsocial = Label(Aboutus, text="Siddharth Chatterjee")

	sidsocial.grid(row=5, sticky='SE',padx = 8)
	alisocial = Label(Aboutus, text="Muhammad Ali")

	alisocial.grid(row=6, sticky='SE',padx = 8)
